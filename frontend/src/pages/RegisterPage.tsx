  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-indigo-300/30 rounded-full blur-3xl"></div>
      ...
      <div className="card-glass w-full max-w-md animate-slide-up relative z-10">
        {/* Logo & Header */}
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold gradient-text mb-2">Join Dashwright</h1>
          <p className="text-gray-600 font-medium">Create your account and start testing</p>
        </div>
