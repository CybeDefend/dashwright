...
import { Users, Mail, UserPlus, XCircle, Trash2, Calendar, CheckCircle, Clock, Ban } from 'lucide-react';
import { invitationService } from '../services/invitationService';
import { Invitation, InvitationWithUrl, CreateInvitationDto, RoleType, InvitationStatus } from '../types';
...
export default function OrganizationPage() {
  ...
  const [createdInvitation, setCreatedInvitation] = useState<InvitationWithUrl | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold gradient-text mb-2">Organization</h1>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`flex items-center gap-1 px-2 py-1 text-xs rounded-full ${getStatusColor(invitation.status)}`}>
      ...
      <ConfirmModal
        ...
        title={confirmModal.type === 'revoke' ? 'Revoke Invitation?' : 'Delete Invitation?'}
        message={
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value={RoleType.MAINTAINER}>Maintainer - Can manage test runs</option>
      ...
      <div className="card max-w-2xl w-full mx-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4 border border-gray-200">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-600 text-sm font-medium">Invitation Link:</span>
            <button
              onClick={handleCopy}
        ...
        <p className="text-gray-600 text-sm mb-4">
          This invitation will expire on {format(new Date(invitation.expiresAt), 'MMMM d, yyyy')}.
        </p>
